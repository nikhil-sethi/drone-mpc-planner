...
NAN_colour = "#909090"
times = ["0:00", "1:00", "2:00", "3:00", "4:00", "5:00", "6:00", "7:00", "8:00", "9:00", "10:00",
...
function getData(dates){
    ...
    date_range.forEach(function(date) {
        ...
        for (var h = 0; h < 24; h++) {
            ...
            data.push({ "day" : format_date(current_date),
                        "hour" : h,
    ...
    cards.enter().append("rect")
       ...
       .on('mouseout', function (d, i) {
        ...
        .on("contextmenu", function(d, i){
            ...
            checkButton();
            console.log(selected_hours_1);
            console.log(selected_hours_2);
        } );    
