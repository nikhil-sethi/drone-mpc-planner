...
def cut_video_for_moth(absolute_video_path: str, delete_raw: bool=False):
    ...
    new_csv.to_csv(os.path.join(main_path, "insect.csv"), sep=";", index=False) # creates a new csv that corresponds to the length of the cut video
    ...
    os.path.join(main_path,"cut_video.mkv")]
...
for found in found_videos:
    cut_video_for_moth(found, args.d)
