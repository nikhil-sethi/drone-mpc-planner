...
*/
  pinMode(PAD1_UP, OUTPUT);
  pinMode(PAD3_UP, OUTPUT);
  pinMode(PAD3_UP, OUTPUT);
  pinMode(PAD1_DOWN, OUTPUT);
  pinMode(PAD2_DOWN, OUTPUT);
  pinMode(PAD3_DOWN, OUTPUT);  
...
/*
  ...
  display = TM1637Display(CLK, DIO);
    */
  digitalWrite(PAD1_UP, 0);
  digitalWrite(PAD3_UP, 0);
  digitalWrite(PAD3_UP, 0);
  digitalWrite(PAD1_DOWN, 1);
  digitalWrite(PAD2_DOWN, 0);
  digitalWrite(PAD3_DOWN, 0);  
}
...
bool find_drone()
{
  int probe1 = analogRead(PROBE1) / 1024.0 * 5000;
  int probe2 = analogRead(PROBE2) / 1024.0 * 5000;
  int probe3 = analogRead(PROBE3) / 1024.0 * 5000;

  //debugln("%d %d %d %d", millis() % 1000, probe1, probe2, probe3);
  //debugln("%d %d %d", probe1, probe2, probe3);
  Serial.print(millis());
  Serial.print(" ");
  Serial.print(probe1);
  Serial.print(" ");
  ...
  else if (millis() % 9000 < 6000)
  {
    digitalWrite(PAD1_DOWN, 0);
    digitalWrite(PAD2_DOWN, 1);
    digitalWrite(PAD3_DOWN, 0);  
  }
  else if (millis() % 9000 < 9000)
  {
    digitalWrite(PAD1_DOWN, 0);
    digitalWrite(PAD2_DOWN, 0);
    digitalWrite(PAD3_DOWN, 1);  
  }*/
