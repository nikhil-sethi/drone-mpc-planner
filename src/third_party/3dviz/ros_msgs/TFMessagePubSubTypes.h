...
#ifndef _TF2_MSGS_MSG_TFMESSAGE_PUBSUBTYPES_H_
#define _TF2_MSGS_MSG_TFMESSAGE_PUBSUBTYPES_H_
...
#error Generated TFMessage is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
...
namespace tf2_msgs
{
    namespace msg
    {
         ...
         * @ingroup TFMESSAGE
         */
        class TFMessagePubSubType : public eprosima::fastrtps::TopicDataType {
        public:
                typedef TFMessage type;

        	TFMessagePubSubType();
        	virtual ~TFMessagePubSubType();
...
#endif // _TF2_MSGS_MSG_TFMESSAGE_PUBSUBTYPES_H_