...
#ifndef _GEOMETRY_MSGS_MSG_TRANSFORM_PUBSUBTYPES_H_
#define _GEOMETRY_MSGS_MSG_TRANSFORM_PUBSUBTYPES_H_
...
#error Generated Transform is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
...
namespace geometry_msgs
{
    namespace msg
    {
         ...
         * @ingroup TRANSFORM
         */
        class TransformPubSubType : public eprosima::fastrtps::TopicDataType {
        public:
                typedef Transform type;

        	TransformPubSubType();
        	virtual ~TransformPubSubType();
...
#endif // _GEOMETRY_MSGS_MSG_TRANSFORM_PUBSUBTYPES_H_