...
public:
    ...
    void run();
#else
    bool init(TrackerManager *trackers [[maybe_unused]], CameraVolume *cam_volume [[maybe_unused]], DroneController *dctrl [[maybe_unused]], DroneNavigation *dnav [[maybe_unused]]){return true;}
    void run(){}
#endif
