...
#ifndef _GEOMETRY_MSGS_MSG_POSE_PUBSUBTYPES_H_
#define _GEOMETRY_MSGS_MSG_POSE_PUBSUBTYPES_H_
...
#error Generated Pose is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
...
namespace geometry_msgs
{
    namespace msg
    {
         ...
         * @ingroup POSE
         */
        class PosePubSubType : public eprosima::fastrtps::TopicDataType {
        public:
                typedef Pose type;

        	PosePubSubType();
        	virtual ~PosePubSubType();
...
#endif // _GEOMETRY_MSGS_MSG_POSE_PUBSUBTYPES_H_