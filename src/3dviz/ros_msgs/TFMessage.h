...
#ifndef _TF2_MSGS_MSG_TFMESSAGE_H_
#define _TF2_MSGS_MSG_TFMESSAGE_H_
...
namespace tf2_msgs
{
    namespace msg
    {
        ...
        public:
             ...
             * @param x Reference to the object tf2_msgs::msg::TFMessage that will be copied.
             */
            eProsima_user_DllExport TFMessage(TFMessage &&x);
             ...
             * @param x Reference to the object tf2_msgs::msg::TFMessage that will be copied.
             */
            eProsima_user_DllExport TFMessage& operator=(TFMessage &&x);

            /*!
             * @brief This function copies the value in member transforms
             * @param _transforms New value to be copied in member transforms
             */
            inline eProsima_user_DllExport void transforms(const std::vector<geometry_msgs::msg::TransformStamped> &_transforms)
            {
             ...
             */
            inline eProsima_user_DllExport void transforms(std::vector<geometry_msgs::msg::TransformStamped> &&_transforms)
            {
             ...
             */
            inline eProsima_user_DllExport const std::vector<geometry_msgs::msg::TransformStamped>& transforms() const
            {
                return m_transforms;
            }
             ...
             */
            inline eProsima_user_DllExport std::vector<geometry_msgs::msg::TransformStamped>& transforms()
            {
                return m_transforms;
            }
             ...
             */
            eProsima_user_DllExport static size_t getCdrSerializedSize(const tf2_msgs::msg::TFMessage& data, size_t current_alignment = 0);
...
#endif // _TF2_MSGS_MSG_TFMESSAGE_H_
