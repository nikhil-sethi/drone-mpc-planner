...
#ifndef _GEOMETRY_MSGS_MSG_TRANSFORMSTAMPED_PUBSUBTYPES_H_
#define _GEOMETRY_MSGS_MSG_TRANSFORMSTAMPED_PUBSUBTYPES_H_
...
#error Generated TransformStamped is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
...
namespace geometry_msgs
{
    namespace msg
    {
         ...
         */
        class TransformStampedPubSubType : public eprosima::fastrtps::TopicDataType {
        public:
...
#endif // _GEOMETRY_MSGS_MSG_TRANSFORMSTAMPED_PUBSUBTYPES_H_