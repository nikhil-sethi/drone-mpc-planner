...
if not os.path.isfile('/home/pats/dependencies/hostname_set'):
    ...
    rsync_cmd = ['rsync -a -e "ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -o LogLevel=ERROR  -i /home/pats/.ssh/id_rsa -F /home/pats/pats/release/install/sshconfig" ' + 'dash:id_db.txt ' + id_db_path]
