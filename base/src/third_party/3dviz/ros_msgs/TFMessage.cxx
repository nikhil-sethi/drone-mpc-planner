...
size_t tf2_msgs::msg::TFMessage::getMaxCdrSerializedSize(size_t current_alignment)
{
...
size_t tf2_msgs::msg::TFMessage::getCdrSerializedSize(const tf2_msgs::msg::TFMessage& data, size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void tf2_msgs::msg::TFMessage::serialize(eprosima::fastcdr::Cdr &scdr) const
{
    scdr << m_transforms;}

void tf2_msgs::msg::TFMessage::deserialize(eprosima::fastcdr::Cdr &dcdr)
{
    dcdr >> m_transforms;}

size_t tf2_msgs::msg::TFMessage::getKeyMaxCdrSerializedSize(size_t current_alignment)
{
...
void tf2_msgs::msg::TFMessage::serializeKey(eprosima::fastcdr::Cdr &scdr) const
{
	(void) scdr;
