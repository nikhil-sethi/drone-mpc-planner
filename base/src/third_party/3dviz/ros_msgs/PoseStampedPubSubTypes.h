...
#ifndef _GEOMETRY_MSGS_MSG_POSESTAMPED_PUBSUBTYPES_H_
#define _GEOMETRY_MSGS_MSG_POSESTAMPED_PUBSUBTYPES_H_
...
#error Generated PoseStamped is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
...
namespace geometry_msgs
{
    namespace msg
    {
         ...
         * @ingroup POSESTAMPED
         */
        class PoseStampedPubSubType : public eprosima::fastrtps::TopicDataType {
        public:
                typedef PoseStamped type;

        	PoseStampedPubSubType();
        	virtual ~PoseStampedPubSubType();
...
#endif // _GEOMETRY_MSGS_MSG_POSESTAMPED_PUBSUBTYPES_H_