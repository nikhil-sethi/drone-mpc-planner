...
#ifndef _STD_MSGS_MSG_HEADER_PUBSUBTYPES_H_
#define _STD_MSGS_MSG_HEADER_PUBSUBTYPES_H_
...
#error Generated Header is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
...
#endif // _STD_MSGS_MSG_HEADER_PUBSUBTYPES_H_