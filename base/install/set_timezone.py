...
if os.path.isfile('/home/pats/dependencies/hostname_set') and not os.path.isfile('/home/pats/dependencies/timezone_set'):
    ...
    cmd = ['ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i /home/pats/.ssh/id_rsa -F /home/pats/code/pats/base/install/sshconfig -T dash /usr/bin/python3 < /home/pats/code/pats/base/install/run_timezone_loader.py - --system ' + system]
